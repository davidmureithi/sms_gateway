...
class Orders extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['OrderStatusId'], 'exist', 'skipOnError' => true, 'targetClass' => Orderstatuses::className(), 'targetAttribute' => ['OrderStatusId' => 'OrderStatusId']],
            [['PaymentId'], 'exist', 'skipOnError' => true, 'targetClass' => Paymenttransactions::className(), 'targetAttribute' => ['PaymentId' => 'PaymentId']],
        ];
    }
