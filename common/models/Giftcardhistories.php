 ...
 */
class Giftcardhistories extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['GiftCardID'], 'exist', 'skipOnError' => true, 'targetClass' => Giftcards::className(), 'targetAttribute' => ['GiftCardID' => 'GiftCardId']],
        ];
    }
