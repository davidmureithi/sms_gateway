 ...
 * @property Productoptionprices[] $productoptionprices0
 * @property Productoptionprices[] $productoptionprices1
 * @property Productoptionprices[] $productoptionprices2
...
class Productoptiongroupmembers extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['Comment'], 'string'],
            [['Name'], 'string', 'max' => 500],
            [['ProductOptionGroupId'], 'exist', 'skipOnError' => true, 'targetClass' => Productoptiongroups::className(), 'targetAttribute' => ['ProductOptionGroupId' => 'ProductOptionGroupId']],
        ];
    }
    ...
    {
        return $this->hasMany(Productoptionprices::className(), ['ProductOptionGroupMemberId1' => 'ProductOptionGroupMemberId']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getProductoptionprices0()
    {
        return $this->hasMany(Productoptionprices::className(), ['ProductOptionGroupMemberId3' => 'ProductOptionGroupMemberId']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getProductoptionprices1()
    {
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getProductoptionprices2()
    {
        return $this->hasMany(Productoptionprices::className(), ['ProductOptionGroupMemberId4' => 'ProductOptionGroupMemberId']);
    }
