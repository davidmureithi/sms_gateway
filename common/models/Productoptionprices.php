...
class Productoptionprices extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['Price'], 'number'],
            [['Comment'], 'string'],
            [['ProductOptionGroupMemberId1'], 'exist', 'skipOnError' => true, 'targetClass' => Productoptiongroupmembers::className(), 'targetAttribute' => ['ProductOptionGroupMemberId1' => 'ProductOptionGroupMemberId']],
            [['ProductOptionGroupMemberId3'], 'exist', 'skipOnError' => true, 'targetClass' => Productoptiongroupmembers::className(), 'targetAttribute' => ['ProductOptionGroupMemberId3' => 'ProductOptionGroupMemberId']],
            [['ProductOptionGroupMemberId2'], 'exist', 'skipOnError' => true, 'targetClass' => Productoptiongroupmembers::className(), 'targetAttribute' => ['ProductOptionGroupMemberId2' => 'ProductOptionGroupMemberId']],
            [['ProductOptionGroupMemberId4'], 'exist', 'skipOnError' => true, 'targetClass' => Productoptiongroupmembers::className(), 'targetAttribute' => ['ProductOptionGroupMemberId4' => 'ProductOptionGroupMemberId']],
