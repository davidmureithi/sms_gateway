...
class Paymenttransactions extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['CreditCardId'], 'exist', 'skipOnError' => true, 'targetClass' => Creditcards::className(), 'targetAttribute' => ['CreditCardId' => 'CreditCardId']],
            [['PaymentTypeId'], 'exist', 'skipOnError' => true, 'targetClass' => Paymenttypes::className(), 'targetAttribute' => ['PaymentTypeId' => 'PaymentTypeId']],
            [['CurrencyCode'], 'exist', 'skipOnError' => true, 'targetClass' => Currencies::className(), 'targetAttribute' => ['CurrencyCode' => 'CurrencyCode']],
        ];
    }
