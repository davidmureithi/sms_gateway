...
class Productoptions extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['ProductOptionGroupMemberId'], 'exist', 'skipOnError' => true, 'targetClass' => Productoptiongroupmembers::className(), 'targetAttribute' => ['ProductOptionGroupMemberId' => 'ProductOptionGroupMemberId']],
