 ...
 * @property Productsrelated[] $productsrelateds0
...
class Products extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['ProductCategoryId'], 'exist', 'skipOnError' => true, 'targetClass' => Productcategories::className(), 'targetAttribute' => ['ProductCategoryId' => 'ProductCategoryId']],
            [['ProductTypeId'], 'exist', 'skipOnError' => true, 'targetClass' => Producttypes::className(), 'targetAttribute' => ['ProductTypeId' => 'ProductTypeId']],
        ];
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getProductsrelateds0()
    {
        return $this->hasMany(Productsrelated::className(), ['ProductId' => 'ProductId']);
    }
