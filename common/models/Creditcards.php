...
class Creditcards extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['Name'], 'string', 'max' => 250],
            [['Bin'], 'string', 'max' => 6],
            [['BankId'], 'exist', 'skipOnError' => true, 'targetClass' => Banks::className(), 'targetAttribute' => ['BankId' => 'BankId']],
            [['CreditCardTypeId'], 'exist', 'skipOnError' => true, 'targetClass' => Creditcardtypes::className(), 'targetAttribute' => ['CreditCardTypeId' => 'CreditCardTypeId']],
        ];
    }
