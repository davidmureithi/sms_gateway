...
class Shippings extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['ShippingStatusId'], 'exist', 'skipOnError' => true, 'targetClass' => Shippingstatuses::className(), 'targetAttribute' => ['ShippingStatusId' => 'ShippingStatusId']],
            [['ShippingTypeId'], 'exist', 'skipOnError' => true, 'targetClass' => Shippingtypes::className(), 'targetAttribute' => ['ShippingTypeId' => 'ShippingTypeId']],
        ];
    }
