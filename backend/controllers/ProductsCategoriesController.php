...
use common\models\SearchProductCategories;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ProductsCategoriesController implements the CRUD actions for Productcategories model.
 */
class ProductsCategoriesController extends Controller
{
    ...
    {
        $searchModel = new SearchProductCategories();
