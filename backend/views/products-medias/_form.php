...
<div class="productmedias-form">
    ...
    <?= $form->field($model, 'SmallImageUrl')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'ImageUrl')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'ZoomImageUrl')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'EmbedCode')->textarea(['rows' => 6]) ?>

    <?= $form->field($model, 'HtmlAlt')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'HtmlTitle')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'FeaturedText')->textInput(['maxlength' => true]) ?>
